    ...
    <section className="lineup-page" data-layout-profile={LINEUP_LAYOUT_PROFILE}>
      ...
      <div className="board">
        <div className="board-controls">
          <div className="controls-cluster controls-cluster-start">
          ...
          <div className="controls-cluster controls-cluster-center">
          ...
          <div className="controls-cluster controls-cluster-end">
        ...
        <div className="column">
          <div className="side-panel squad-panel">
